...
struct UserProfile: Identifiable, Codable {
    ...
    init(id: String? = nil, userId: String, email: String, displayName: String, username: String, bio: String, profilePhotoUrl: String? = nil, blogUrl: String? = nil, brunchUrl: String? = nil, instagramUrl: String? = nil, twitterUrl: String? = nil, threadsUrl: String? = nil, createdAt: Date, essayCount: Int = 0, totalWordCount: Int = 0, streakDays: Int = 0, following: [String] = [], friends: [String] = []) {
        self.id = id
        self.userId = userId
        self.email = email
    ...
    var dictionary: [String: Any] {
        ...
        if let profilePhotoUrl = profilePhotoUrl { dict["profilePhotoUrl"] = profilePhotoUrl }
